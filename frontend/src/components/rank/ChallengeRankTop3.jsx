...
export const ChallengeRankTop3 = () => {
    return (
        <Box direction='row' justify='evenly' width='100%' align='end' margin="20px 0px">
            <Box direction='column' height="85px" justify='between' align='center'>
                <Profile2nd src='https://picsum.photos/400/300' alt="프로필 사진" />
                <Box direction='column'>
                    <Text size='10px' weight='400'>문석희</Text>
                    <Text size='10px' weight='400'>24.5%</Text>
                </Box>
            </Box>
            <Box direction='column' height="120px" justify='between' align='center' style={{ position: 'relative' }}>
                <img src={crown} alt="왕관 사진" style={{ position: "absolute", top: '-20px', left: '30px' }} />
                <Profile1st src='https://picsum.photos/400/300' alt="프로필 사진" />
                <Box direction='column' align='center'>
                    <Text size='12px' weight='500'>권기정</Text>
                    <Text size='10px' weight='400'>24.5%</Text>
                </Box>
            </Box>
            <Box direction='column' height="85px" justify='between' align='center'>
