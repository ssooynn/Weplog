    ...
    <ChallengeRankStyled>
      <Box direction="row" justify='between' width="100%" align='center'>
        <Box direction='row' width="35%" align='center'>
          <Text size="14px" weight="400" color="#00853B">5</Text>
          <Box direction='row' width="70%" justify="between" margin={{ left: "20px" }} align='center'>
            <RankProfileImg src='https://picsum.photos/400/300' alt="프로필 사진"></RankProfileImg>
            <Text size="13px" weight="400"> 이아현 </Text>
          </Box>
        </Box>
        <Text size="14px" weight="400" color="#00853B">6.2%</Text>
      </Box>
    </ChallengeRankStyled >
  )
}
