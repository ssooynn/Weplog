...
import { challengeEndListAPi, challengeIngListAPi } from '../../apis/memberChallengeApi';
    ...
    return (
        ...
        >
            ...
            <Box direction='column' width='100%' pad="large">
                ...
                {(challengeIngList !== undefined && challengeIngList.length > 0) ? <ChallengeCardList ChallengeList={challengeIngList} /> : <Text size="10px" weight={500}>
                    진행중인 챌린지가 없습니다.
                </Text>}
            ...
            <Box direction='column' width='100%' pad="0px 24px 24px 24px">
                ...
                {(challengeEndList !== undefined && challengeEndList.length > 0) ? <ChallengeCardList ChallengeList={challengeEndList} /> : <Text size="10px" weight={500}>
                    완료된 챌린지가 없습니다.
                </Text>}
            </Box>
        </Box>
