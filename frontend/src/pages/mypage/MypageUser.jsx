...
export const MypageUser = () => {
    ...
    return (
        <Box direction="column" height="auto" justify="start" style={{ minHeight: "700px" }}>
            {/* 제목 Header */}
            <Box direction='row' pad="18px" width="100%" height="60px" justify="between" align="center" border={{ color: "#EAEAEA", size: "2px", styled: "solid", side: "bottom" }}>
                <img src={leftArrowIcon} width='30px' height='30px' onClick={(e) => navigate(-1)} />
